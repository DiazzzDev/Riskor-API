...
public class ServiceEPPLoan {
    ...
    public Page<DTOEPPLoan> getAllEPPLoan(String idBusiness, int page, int size){
        ...
        Page<EntityEPPLoan> permissionPage = objRepoEPPLoan.findByIdBusiness_IdBusiness(idBusiness.toUpperCase(), pageable);
        return permissionPage.map(this::convertTOEPPLoanDTO);
    }
